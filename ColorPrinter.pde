...
void setup() {
    ...
    shapeLogo = loadShape(palettesFolder + "LOGO.svg");
...
void exportPage(String paletteFilename) {
...
//                if (files[i].getName().matches(".*palette.*\\.svg")) {
...
//                    //Create a pdf file with the same name as the svg file
